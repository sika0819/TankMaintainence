...
public class LetterAction
{
	...
	[SerializeField]
	TextAnchor m_letter_anchor = TextAnchor.MiddleCenter;
	
	[SerializeField]
	AudioClip m_audio_on_start;
	[SerializeField]
	ActionFloatProgression m_audio_on_start_delay = new ActionFloatProgression(0);
	[SerializeField]
	ActionFloatProgression m_audio_on_start_offset = new ActionFloatProgression(0);
	[SerializeField]
	ActionFloatProgression m_audio_on_start_volume = new ActionFloatProgression(1);
	[SerializeField]
	ActionFloatProgression m_audio_on_start_pitch = new ActionFloatProgression(1);
	[SerializeField]
	
	AudioClip m_audio_on_finish;
	[SerializeField]
	ActionFloatProgression m_audio_on_finish_delay = new ActionFloatProgression(0);
	[SerializeField]
	ActionFloatProgression m_audio_on_finish_offset = new ActionFloatProgression(0);
	[SerializeField]
	ActionFloatProgression m_audio_on_finish_volume = new ActionFloatProgression(1);
	[SerializeField]
	ActionFloatProgression m_audio_on_finish_pitch = new ActionFloatProgression(1);
	
	[SerializeField]
	ParticleEmitter m_emitter_on_start;
	[SerializeField]
	bool m_emitter_on_start_per_letter = true;
	[SerializeField]
	ActionFloatProgression m_emitter_on_start_delay = new ActionFloatProgression(0);
	[SerializeField]
	ActionFloatProgression m_emitter_on_start_duration = new ActionFloatProgression(0);
	[SerializeField]
	bool m_emitter_on_start_follow_mesh = false;
	[SerializeField]
	ActionVector3Progression m_emitter_on_start_offset = new ActionVector3Progression(Vector3.zero);
	
	[SerializeField]
	ParticleEmitter m_emitter_on_finish;
	[SerializeField]
	bool m_emitter_on_finish_per_letter = true;
	[SerializeField]
	ActionFloatProgression m_emitter_on_finish_delay = new ActionFloatProgression(0);
	[SerializeField]
	ActionFloatProgression m_emitter_on_finish_duration = new ActionFloatProgression(0);
	[SerializeField]
	bool m_emitter_on_finish_follow_mesh = false;
	[SerializeField]
	ActionVector3Progression m_emitter_on_finish_offset = new ActionVector3Progression(Vector3.zero);
#endif	
	...
	public void InitialiseLetterAnchorType()
	{
	...
	{
		bool handled_legacy_setup = false;
		
		if(m_audio_on_start != null)
		{
			m_audio_effects.Add(new AudioEffectSetup(){
									m_audio_clip = m_audio_on_start,
									m_delay = m_audio_on_start_delay,
									m_effect_assignment = PLAY_ITEM_ASSIGNMENT.PER_LETTER,
									m_effect_assignment_custom_letters = new List<int>(),
									m_loop_play_once = false,
									m_offset_time = m_audio_on_start_offset,
									m_pitch = m_audio_on_start_pitch,
									m_play_when = PLAY_ITEM_EVENTS.ON_START,
									m_volume = m_audio_on_start_volume
								});
		...
		{
			m_audio_effects.Add(new AudioEffectSetup(){
									m_audio_clip = m_audio_on_finish,
									m_delay = m_audio_on_finish_delay,
									m_effect_assignment = PLAY_ITEM_ASSIGNMENT.PER_LETTER,
									m_effect_assignment_custom_letters = new List<int>(),
									m_loop_play_once = false,
									m_offset_time = m_audio_on_finish_offset,
									m_pitch = m_audio_on_finish_pitch,
		...
		if(m_emitter_on_start != null)
		{
			...
			m_particle_effects.Add(new ParticleEffectSetup(){
										m_legacy_particle_effect = m_emitter_on_start,
										m_delay = m_emitter_on_start_delay,
										m_duration = m_emitter_on_start_duration,
										m_effect_type = PARTICLE_EFFECT_TYPE.LEGACY,
										m_follow_mesh = m_emitter_on_start_follow_mesh,
										m_position_offset = m_emitter_on_start_offset,
										m_rotate_relative_to_letter = true,
										m_rotation_offset = new ActionVector3Progression(new Vector3(0,180,0)),
										m_effect_assignment = m_emitter_on_start_per_letter ? PLAY_ITEM_ASSIGNMENT.PER_LETTER : PLAY_ITEM_ASSIGNMENT.CUSTOM,
										m_effect_assignment_custom_letters = m_emitter_on_start_per_letter ? new List<int>() : new List<int>(){0},
										m_loop_play_once = false,
										m_play_when = PLAY_ITEM_EVENTS.ON_START
									});
		...
		if(m_emitter_on_finish != null)
		{
			// Old Particle effect setup to port over.
			m_particle_effects.Add(new ParticleEffectSetup(){
										m_legacy_particle_effect = m_emitter_on_finish,
										m_delay = m_emitter_on_finish_delay,
										m_duration = m_emitter_on_finish_duration,
										m_effect_type = PARTICLE_EFFECT_TYPE.LEGACY,
										m_follow_mesh = m_emitter_on_finish_follow_mesh,
										m_position_offset = m_emitter_on_finish_offset,
										m_rotate_relative_to_letter = true,
										m_rotation_offset = new ActionVector3Progression(new Vector3(0,180,0)),
										m_effect_assignment = m_emitter_on_finish_per_letter ? PLAY_ITEM_ASSIGNMENT.PER_LETTER : PLAY_ITEM_ASSIGNMENT.CUSTOM,
										m_effect_assignment_custom_letters = m_emitter_on_finish_per_letter ? new List<int>() : new List<int>(){0},
										m_loop_play_once = false,
										m_play_when = PLAY_ITEM_EVENTS.ON_FINISH
									});
