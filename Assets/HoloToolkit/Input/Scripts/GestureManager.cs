...
namespace HoloToolkit.Unity
{
    ...
    public partial class GestureManager : Singleton<GestureManager>
    {
        ...
        public Vector3 MyManipulationPosition { get; private set; }
        /// <summary>
      ...
      //  public Button NextStep;
       ...
       // public Button BackToMain;
        ...
        private Vector3 LastHitPosition;//记录包络面的最终位置
       // private Button Btnselected; //button gazed at
       // private Vector3 hitPos, hitNormal;
        ...
        //private CreateObject NewInSpace = new CreateObject();
        private void Awake()
        {
          ...
          //  InteractionManager.SourceReleased += InteractionManager_SourceReleased;
           ...
           // InteractionManager.SourceLost += InteractionManager_SourceLost;
            ...
            gestureRecognizer.SetRecognizableGestures(GestureSettings.Tap| GestureSettings.DoubleTap | GestureSettings.ManipulationTranslate);
            ...
            manipulationRecognizer.SetRecognizableGestures( GestureSettings.NavigationX| GestureSettings.NavigationY);
            ...
            manipulationRecognizer.NavigationCanceledEvent += ManipulationRecognizer_NavigationCanceledEvent;
        ...
        private void GestureRecognizer_ManipulationStartedEvent(InteractionSourceKind source, Vector3 cumulativeDelta, Ray headRay)
        {
            ...
            if (HandsManager.Instance.FocusedGameObject != null)
            {
                ...
                MyManipulationPosition = cumulativeDelta;
        ...
        private void ManipulationRecognizer_NavigationCanceledEvent(InteractionSourceKind source, Vector3 normalizedOffset, Ray headRay)
        {
            IsNavigating = false;
        }

        private void ManipulationRecognizer_NavigationCompletedEvent(InteractionSourceKind source, Vector3 normalizedOffset, Ray headRay)
        {
            IsNavigating = false;
        }
        private void ManipulationRecognizer_NavigationUpdatedEvent(InteractionSourceKind source, Vector3 normalizedOffset, Ray headRay)
        {
            IsNavigating = true;
            //偏移量  
            NavigationPosition = normalizedOffset;
            HandsManager.Instance.FocusedGameObject.SendMessageUpwards("PerformRotate", NavigationPosition);
        }

        private void ManipulationRecognizer_NavigationStartedEvent(InteractionSourceKind source, Vector3 normalizedOffset, Ray headRay)
        {
            IsNavigating = true;
            NavigationPosition = normalizedOffset;
            HandsManager.Instance.FocusedGameObject.SendMessageUpwards("PerformRotate", NavigationPosition);
        ...
        private void GestureRecognizer_TappedEvent(InteractionSourceKind source, int tapCount, Ray headRay)
        {
            ...
            if ( tapCount == 1)
            {
             //   StartCoroutine(Wait1Second());
              ...
              //  if (tapCount == 1)
             //   {                  
                    //GuidanceSet.Instance.SetButtonClicked();       
                    NewGuidanceSet.Instance.SetButtonClicked();
                    if (HitChildShow.Instance.IfCoverSet == false)
                    {
                      //  HitChildShow.Instance.TextPlane.transform.position = GazeManager.Instance.Position;
                   //     LastHitPosition = GazeManager.Instance.Position;
                    //    HitChildShow.Instance.TextPlane.transform.forward = Camera.main.transform.up ;
            ...
            else if(tapCount == 2)
            {
               ...
               // else
                {
                    // if (GuidanceSet.Instance.GuidanceHideSet == true)
                    if (NewGuidanceSet.Instance.GuidanceHideSet == true)
                    {
                        // GuidanceSet.Instance.GuidanceHideSet = false;
                        // GuidanceSet.Instance.GuidanceCanvasEnable = true;
                        NewGuidanceSet.Instance.GuidanceHideSet = false;
                        SetCanvas.Instance.GuidanceCanvasEnable = true;
                   //     if (GuidanceManager.Instance.GuidanceStep == 0)
                        {
                           // NewGuidanceSet.Instance.DiZuo.SetActive(false);
                          //  NewGuidanceSet.Instance.PaoTa.SetActive(true);
                         //   NewGuidanceSet.Instance.PaoTa.transform.position = Camera.main.transform.position + Camera.main.transform.up * NewGuidanceSet.Instance.ObjectDown + Camera.main.transform.forward * NewGuidanceSet.Instance.ObjectDistance;
                            // NewGuidanceSet.Instance.CreateObjects(NewGuidanceSet.Instance.ObjectDown, NewGuidanceSet.Instance.ObjectDistance, "PaoTa", NewGuidanceSet.Instance.ObjectsStatic);
                        }

                       // if (GuidanceManager.Instance.GuidanceStep == 1)
                        {
                       //     NewGuidanceSet.Instance.PaoTa.SetActive(false);
                        //    NewGuidanceSet.Instance.DiZuo.SetActive(true);
                       //     NewGuidanceSet.Instance.DiZuo.transform.position = Camera.main.transform.position + Camera.main.transform.up * NewGuidanceSet.Instance.ObjectDown + Camera.main.transform.forward * NewGuidanceSet.Instance.ObjectDistance;
                            // NewGuidanceSet.Instance.CreateObjects(NewGuidanceSet.Instance.ObjectDown, NewGuidanceSet.Instance.ObjectDistance, "DiZuo", NewGuidanceSet.Instance.ObjectsStatic);
                        }
                    }

                    else if (NewGuidanceSet.Instance.MainHideSet == true)
                    {
                        NewGuidanceSet.Instance.MainHideSet = false;
                        SetCanvas.Instance.MainCanvasEnable = true;
                    }

                    else if(NewGuidanceSet.Instance.IfMaintainHide  ==true)
                    {
                        NewGuidanceSet.Instance.IfMaintainHide = false;
