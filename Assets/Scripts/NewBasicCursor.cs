...
namespace HoloToolkit.Unity
{
    ...
    /// </summary>
    public class NewBasicCursor : Singleton<NewBasicCursor>
    {
     ...
     //   public bool IfHit;
        ...
        //    NotHit = false;
         ...
         //   if ((GazeManager.Instance.RaycastLayerMask[0] & (1 << gameObject.layer)) != 0)
          //  {
        ...
        public RaycastResult CalculateRayIntersect()
        {
     ...
     //   {
      ...
      //  }
...

        {
         ...
         //   IfHit = rayResult.Hit;
           // if(!rayResult.Hit)
           //    NewGuidanceSet .Instance .IfGuidanceFix = rayResult.Hit;
           //   NewGuidanceSet .Instance . IfMainFix  = rayResult.Hit;
